...
let adminCalendarViewing = new Date(); // CORREÇÃO: Variável renomeada de adminViewingDate
...
function showProvasDayDetails(iso, interns) {
    ...
    if (interns.length === 0) {
        ...
        interns.forEach(intern => {
            ...
            // CORREÇÃO: Adicionado o ID do estagiário para corresponder ao original
...
function renderReports() {
    ...
    // estilos inline para aplicar diretamente no HTML
    ...
    // estilos para os cabeçalhos (apresentados como "badges" maiores)
